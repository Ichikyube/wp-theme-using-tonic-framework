...
<?php
     ...
     *
     * @hooked cooler\Index\render_header - 10
     */
...
<section class="section">
    <div class="wrapper">
        <div id="content" class="site-content" data-spy="scroll" data-target="#navbar-example" >
            <?php if (have_posts()) : ?>
                <h4>Posts</h4>
                ...
                <div class="posts">
                    <?php while (have_posts()) : the_post() ?>
                        <?php
                             ...
                             *
                             * @hooked cooler\App\Structure\render_post_thumbnail - 10
                             */
            ...
            <?php else : ?>
                <?php
                     ...
                     *
                     * @hooked cooler\App\Structure\render_empty_content - 10
                     */
        ...
        <?php if (apply_filters('theme/index/sidebar/visibility', true)) : ?>
            <?php
                 ...
                 *
                 * @hooked cooler\App\Structure\render_sidebar - 10
                 */
