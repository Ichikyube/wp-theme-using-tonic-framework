...
add_action('theme/index/post/thumbnail', 'cooler\App\Structure\render_post_thumbnail');
...
add_action('theme/index/content/none', 'cooler\App\Structure\render_empty_content');
...
add_action('theme/single/content', 'cooler\App\Structure\render_post_content');
...
add_action('theme/index/sidebar', 'cooler\App\Structure\render_sidebar');
add_action('theme/single/sidebar', 'cooler\App\Structure\render_sidebar');
...
add_action('theme/header/end', 'cooler\App\Structure\render_documentation_button');
